"""
Disclaimer: The code in this file is based on the training code by the following Dreambooth implementation:
https://github.com/tomasyany/dreambooth/
"""
...
class ImageLogger(Callback):
    ...
    def log_local(self, save_dir, split, images,
        ...
        for k in images:
            ...
            Image.fromarray(grid[:,:,:3]).convert('RGB').save(path)
...
if __name__ == "__main__":
    ...
    try:
        ...
        if not "gpus" in trainer_config: # What exactly is this trying to achieve?
        ...
        trainer = Trainer.from_argparse_args(trainer_opt, accelerator='auto', **trainer_kwargs)
        ...
        print("Run completed, no exceptions!")
    except Exception:
